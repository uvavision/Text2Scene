...
class DrawModel(nn.Module):
    ...
    def forward(self, input_inds, input_lens, start_step, explore_rate, explore_mode, ref_inds):
        return self.inference(input_inds, input_lens, start_step, explore_rate, explore_mode, ref_inds)

    def teacher_forcing(self, input_inds, input_lens, input_bg_imgs, input_fg_onehots, input_hmaps):
